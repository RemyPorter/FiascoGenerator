Incomplete Python3 tool for generating Fiasco setups, and it will *eventually* support many *kinds* of setups (instead of the normal circular connections between characters).
